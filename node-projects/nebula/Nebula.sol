...
contract NebulaNodesV2 is ERC20, Ownable, PaymentSplitter {
    ...
    address public joeRouterAddress =
        0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // TraderJoe Router 0x60aE616a2155Ee3d9A68541Ba4544862310933d4
    address public constant BURN_ADDRESS =
        0x000000000000000000000000000000000000dEaD;
    IERC20 public OLD_CONTRACT =
        IERC20(0x1aEa17a08EdE10D158baac969f809E6747cb2B22);
    ...
    INodeManagerOLD private OLD_MANAGER =
        INodeManagerOLD(0xd311d77c8F4665bdA9e684Cd08f8991f364AbEF5);
    ...
    constructor(
        ...
        uint256[] memory fees,
        uint256 swapAmount
    ) ERC20("NebulaNodes", "NeBu") PaymentSplitter(payees, shares) {
        require(
    ...
    function migrateOldNode() external {
        ...
        require(!hasMigrate[sender], "Node has been already migrate");
    ...
    function setBlockToPass(uint256 value) external onlyOwner {
        blocktopass = value;
    }
    ...
    function _transfer(
        ...
        if (antiBot == true) {
            ...
            if (to == joePair) {
                uint256 lastBlock = userLastBlockBuyTransactions[sender];
                getCurrentBlock();
        ...
        external
    {
        ...
        if (
            ...
            uint256 teamTokens = contractTokenBalance.mul(teamPoolFee).div(
                10000
            );
